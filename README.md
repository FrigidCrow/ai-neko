...
**当前开发分支新增**：可编辑猫娘人格、选定窗口的当轮视觉、按键语音输入与按句语音回复、默认按需共享联网查询，以及本地长期记忆的保存、召回、依据、纠正与遗忘。已参照 N.E.K.O 并提取分词/BM25 纯组件，完整实现、使用方法和未完成验收见 [五项能力说明](docs/COMPANION-IMPLEMENTATION.md)。这些功能尚未发布到旧版下载页；[本轮 CI](https://github.com/FrigidCrow/ai-neko/actions/runs/36225891452) 已通过Windows469项、冻结后端16项、桌宠9项和新增陪伴闭环13项；可登录GitHub下载 [Windows开发包](https://github.com/FrigidCrow/ai-neko/actions/runs/36225891452/artifacts/10901235961)。真实云服务、Windows11游戏场景与质量/时延仍未验收。
