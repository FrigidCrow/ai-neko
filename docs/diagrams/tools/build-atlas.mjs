...
const coverage = [
  ...
  ['tools：查攻略与公开资料','08-tools','搜索、正文、版本和来源；不做键鼠控制'],
...
<main id="content"><header id="top"><div class="eyebrow">WINDOWS 优先 / LANGGRAPH / 本地长期记忆</div><h1>把 ai-neko 看明白</h1><p class="lead">先看做事顺序和整体分工，再沿着一句话，走进对话、记忆、语音与桌面模块。</p><p class="status">这些图是规划设计，已同步 M1 查攻略优先的需求。当前进度以实施计划和验收记录为准；完整产品能力仍需逐阶段验证。</p><div class="quick"><a href="#00-roadmap">① 开发路线</a><a href="#01-architecture">② 整体架构</a><a href="#02-turn">③ 一次对话</a><a href="#10-memory">④ 本地记忆</a><a href="#13-audio">⑤ 语音交互</a></div><p class="read-guide">流程图沿箭头读；时序图从上往下读；状态图看触发条件；ER 图看记录间关系。所有图都可打开大图查看。</p><div class="docs"><a href="../PLAN.md">实施计划</a><a href="../ARCHITECTURE.md">接口设计</a><a href="../DIAGRAM-SKILLS.md">技能调研</a><a href="../../REVIEW.md">验证记录</a></div></header>
...
const md = ['# ai-neko 计划与模块图册','', '**图册为规划设计，已同步查攻略优先的需求；当前实施进度见 PLAN 和 REVIEW。** M0 已进入实现；图册与文档完成不代表 Windows App 已经可用。','', '[打开离线图册](diagrams/index.html) · [技能调研](DIAGRAM-SKILLS.md) · [实施计划](PLAN.md) · [架构接口](ARCHITECTURE.md)','', '推荐先读 00 → 01 → 02，再按模块阅读。流程图沿箭头读，时序图从上往下读；状态图看触发条件，ER 图只表示概念关系。图册不虚构开发工期。','', '## 模块覆盖','', '| 计划 / 模块 | 对应图 | 理解重点 |','| --- | --- | --- |', ...coverage.map(([m,ids,n])=>`| ${m} | ${ids.split(',').map(id=>`[${id.slice(0,2)}](#diagram-${id})`).join(' / ')} | ${n} |`),''];
